...
<div class="virtual-museum z-mid">
    <div class="virtual-museum__content media-container">
        ...
        <div class="virtual-museum__media-content media__content margin-left-xl">
            ...
            <p class="text-bold text-white margin-bottom-s" style="text-align: justify;">Sebagai bentuk apresiasi terhadap karya peserta, seluruh output kreatif akan dipamerkan melalui ekshibisi online. Festival Ajisaka 2020+ mengambil konsep 3D, di mana pengunjung dapat menghadiri ekshibisi selayaknya menjelajahi musem sungguhan. Rasakan sensasi berbeda mengunjungi <i>creative museum</i> dalam bentuk digital!
            <br><br>
            Periode ekshibisi sudah selesai. Terima kasih karena telah mengapresiasi!
            </p>
