...
<div class="lomba">
    ...
    <section class="lomba-desc media-container z-max">
        ...
        <div class="media__content lomba-desc__media-content lomba-desc__media-content--right">
            ...
            <p class="text-regular">Merupakan kategori dalam Arjuna yang menantang insan kreatif untuk menyampaikan pesan dan informasi dalam panel komik yang berisikan edukasi dan mitigasi kebencanaan.
            <br><br>
    ...
    <section class="lomba-desc media-container z-max">
        <div class="media__content lomba-desc__media-content">
            ...
            <p class="text-regular">Homeless Media mengajak insan kreatif untuk merancang konten untuk media sosial Instagram. Konten dirancang sedemikian rupa sehingga berisi informasi yang edukatif, kreatif, dan mengandung fakta sebagaimana produk jurnalistik.
            <br><br>
    ...
    <section class="lomba-desc media-container z-max">
        <img src="/images/logolomba/podcast.png" alt="" class="media media-left lomba-desc__video">
        <!-- <video class="media media-left lomba-desc__video" controls>
            <source src="movie.mp4" type="video/mp4">
        </video> -->
        <div class="media__content lomba-desc__media-content lomba-desc__media-content--right">
            <h3 class="heading-3 text-uppercase text-black margin-bottom-s">Podcast</h3>
            <p class="text-regular">Podcast meminta insan kreatif untuk menyampaikan informasi jurnalistik berupa audio dalam durasi tertentu. Melalui kategori Podcast ini, diharapkan insan kreatif mampu menyampaikan informasi yang edukatif dan inovatif dalam membantu mengurangi risiko kebencanaan kepada audiens.
            <br><br>
